...
import { Trash2, Reply, MoreHorizontal, Flag } from "lucide-react";
...
export function MessageBubble({
  ...
  return (
    <>
      ...
      {/* Report modal — rendered outside bubble div to avoid z-index issues */}
      <ReportModal
        open={showReport}
        onOpenChange={setShowReport}
        targetType="message"
        targetId={message._id}
        targetLabel={`Message from ${message.sender.name}`}
      />
    </>
  );
}
